...
float minDist = 6.0;//min pixel spacing between points in vector path (to prevent cutter from freaking out)
...
void setup(){
  ...
  int section = 1;
  beginRecord(PDF, filename + "1.pdf");//save as PDF
    ...
    switch (section) {
      case 1:
        if (numGrooves==20){
          endShape();
          endRecord();
          beginRecord(PDF, filename + "2.pdf");//save as PDF
          noFill();//don't fill loops
          strokeWeight(0.001);//hairline width
          stroke(255,0,0);
          beginShape();
      ...
      case 2:
        if (numGrooves==42){
          endShape();
          endRecord();
          beginRecord(PDF, filename + "3.pdf");//save as PDF
          noFill();//don't fill loops
          strokeWeight(0.001);//hairline width
          stroke(255,0,0);
          beginShape();
      ...
      case 3:
        if (numGrooves==78){
          endShape();
          endRecord();
          beginRecord(PDF, filename + "4.pdf");//save as PDF
          noFill();//don't fill loops
          strokeWeight(0.001);//hairline width
          stroke(255,0,0);
          beginShape();
      ...
      case 4:
        if (numGrooves==118){
          endShape();
          endRecord();
          beginRecord(PDF, filename + "5.pdf");//save as PDF
          noFill();//don't fill loops
          strokeWeight(0.001);//hairline width
          stroke(255,0,0);
          beginShape();
